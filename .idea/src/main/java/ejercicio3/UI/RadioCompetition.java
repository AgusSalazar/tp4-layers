...
public class RadioCompetition {
    ...
    private RegistroConcursos concursos;
    private RegistroInscripciones inscripciones;

    public RadioCompetition(RegistroConcursos concursos, RegistroInscripciones inscripciones) {
        ...
        btnOk.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    Persona p = new Persona(txtName.getText(), txtLastName.getText(), txtId.getText(), txtEmail.getText(), txtPhone.getText());
                    p.elegirConcurso(comboBox.getSelectedIndex());   // elije el concurso y se guarda su indice como idConcurso
                    inscripciones.saveInscription(p);
